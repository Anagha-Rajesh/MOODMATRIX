...
app1 = Flask(__name__)
app1.config['SQLALCHEMY_DATABASE_URI'] = "sqlite:///C:/Users/anagh/Desktop/Mini project reference/instance/user.db"  # Change this to your SQL database URI
...
rf_classifier = joblib.load('C:/Users/anagh/Desktop/Mini project reference/random_forest_model.pkl')

# Load the feature scaler
scaler = joblib.load('C:/Users/anagh/Desktop/Mini project reference/scaler.pkl')
